...
1. Create a new branch for today's challenge called `strings`
   - `git checkout -b strings`
1. Retrieve the code challenge from the system
   - `npm run get-challenge 13`
1. In your terminal, from the `javascript` folder, run `npm test 13` to execute the tests in this file for **today's challenge.**
