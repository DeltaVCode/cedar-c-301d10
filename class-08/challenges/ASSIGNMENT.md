# Code Challenge 08: Regular Expressions, part 1
...
1. In your terminal, from the `javascript` folder, run `npm test 08` to execute the tests in this file for **today's challenge.**
